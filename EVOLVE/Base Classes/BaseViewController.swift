...
public class BaseViewController : UIViewController,UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
//    }
    ...
    func stopActivity(containerView: UIView? = nil) {
        ...
        self.mainContainer?.topBarView.isUserInteractionEnabled = true
    ...
    func startActivity() {
        ...
        self.mainContainer?.topBarView.isUserInteractionEnabled = false
    }
