...
extension UITextField {
    @IBInspectable var placeHolderColor: UIColor? {
        ...
        set {
            self.attributedPlaceholder = NSAttributedString(string:self.placeholder != nil ? self.placeholder! : kBlankString, attributes:[NSAttributedString.Key.foregroundColor: newValue!])
        }
    }
